...
Em anexo é apresentado um diagrama UML para demonstrar a estrutura das classes, como também um protótipo para declaração desse programa implementado em C++, onde podemos utilizar os arquivos de cabeçalho (*files .h*) para fornecer informações em arquivos gerais de execução, facilitando a organização do projeto.
